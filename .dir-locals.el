;; Copyright (C) 2023 by Luke Shumaker
;;
...
;;
;; DESCRIPTION:
;;	Auto-indent settings for GNU Emacs

;; We use 'nil' instead of 'c' or 'c++' so that we don't have to worry
;; about which one it chooses or duplicate this for each.
